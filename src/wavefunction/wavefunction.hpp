...
public:
    explicit WaveFunction(const Particles& particles, double box_length, double a = 0.5,
        ...
        : jastrow_pade_{box_length, a, b}, slater_plane_wave_{particles, box_length},
          ...
          derivatives_{particles.num_particles_get(), NUM_ARRAYS_} {}
    ...
    [[nodiscard]] const SlaterPlaneWave& slater_plane_wave_get() const {
    ...
    [[nodiscard]] std::size_t steps_since_refresh_get() const noexcept {
        return steps_since_refresh_;
    }
    ...
    void evaluate_derivatives(Particles& particles, bool move_accepted, std::size_t moved,
